...
class Status implements IStatus {
	...
	public function __construct($severity, $id, $code, $message, $exception = null, $name = null, $container = array()) {
	...
	public function __toString() {
		$status_text = static::GetStatusText();
		return sprintf(
			'%s %s: %s',
			static::NAME,
				$status_text[$this->getCode()],
			$this->getMessage()
		);
	}

	public static function NotFound ($message, $values = array()) {
		return new static(self::FATAL, self::ID_FLYWHEEL, self::NOT_FOUND, vsprintf($message, $values));
	}

	public static function Found ($message, $values = array()) {
