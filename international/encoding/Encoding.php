...
class Encoding {
	...
	public static function encofingList () {
		return array(self::ASCII, self::JIS, self::JIS_MS, self::UTF_8, self::EUCJP_WIN, self::EUC_JP, self::SJIS_WIN, self::SJIS);
	}
	 ...
	 */
	public static function Compare ($string, $target_encoding, $encoding_list = null) {
		if (is_null($encoding_list)) {
			$encoding_list = static::encofingList();
		}
	 ...
	 */
	public static function Detect ($string, $encoding_list = null) {
		if (is_null($encoding_list)) {
			$encoding_list = static::encofingList();
		}
	 ...
	 */
	public static function Adjust ($string, $to_encoding = null, $encoding_list = null) {
		if (is_null($encoding_list)) {
			$encoding_list = static::encofingList();
		}
